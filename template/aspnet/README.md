...
faas-cli template pull https://github.com/one-acre-fund/faas-aspnet-template#net10-multi
...
├── .dockerignore
└── function.slnx                       # Single solution, all projects
```
...
3. Add the project to `function.slnx`
